public class BinaryTree<T> implements BinaryTreeInterface<T>
{
   ...
   public void postorderTraverse_callBinaryNodeMethod()
   {
      ...
      node.postorderTraverse_binaryNodeMethod(this.root);
   }
   ...
   @return  The height of the "whole" tree. */
   public int getHeight_callBinaryNodeMethod(BinaryNode<T> node)
   {
     	return node.getHeight_binaryNodeMethod(node);
   ...
   private int getNumberOfNodes(BinaryNode<T> node)
   {
      ...
      if (node.getLeftChild() != null)
         leftValue = getNumberOfNodes(node.getLeftChild());
      if (node.getRightChild() != null)
         rightValue = getNumberOfNodes(node.getRightChild());
